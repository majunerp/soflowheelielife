...
export const metadata: Metadata = {
  title: 'Game Controls Guide - SoFlo Wheelie Life',
  description: 'Master motorcycle wheelies and stunts with our controls guide. Learn keyboard shortcuts, advanced techniques, and pro tips for SoFlo Wheelie Life.',
  keywords: ['game controls', 'how to play', 'wheelie controls', 'motorcycle game guide', 'soflo wheelie life controls', 'stunt game tutorial'],
  alternates: {
    canonical: 'https://soflo-wheelie-life.com/controls',
  },
  openGraph: {
    title: 'Game Controls Guide - SoFlo Wheelie Life',
    description: 'Master motorcycle wheelies and stunts with our controls guide. Learn keyboard shortcuts, advanced techniques, and pro tips for SoFlo Wheelie Life.',
    url: 'https://soflo-wheelie-life.com/controls',
